...
public class GeradorCSV {
    ...
    public static void salvarResultados(String nomeArquivo, String tipoTabelaHash, int tamanhoTabela, int quantidadeRegistros, double tempoInsercaoMs, double tempoBuscaMs, long colisoes) {
