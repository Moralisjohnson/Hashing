...
public class TabelaHash{
    ...
    private final double A = 0.6180339887; // Constante A para a multiplicação
    private int tamanho;
    ...
    while (vetorHash[indice] != null){
        colisoes++;
        indice = (indice + 1) % tamanho; // Usando o formato circular
    }
    ...
    public static void main(String[] args){
        ...
        switch (escolha){
            ...
            case 2:
                ...
                break;
            case 3:
                quantidadeRegistros = arrayQuantidadeRegistros[3];
                tamanhoTabelaHash = arrayTamanhos[3];
                break;
            default:
